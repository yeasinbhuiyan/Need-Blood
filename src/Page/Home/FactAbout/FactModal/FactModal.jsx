...
const FactModal = ({ factAbout, setFactAbout }) => {
    ...
    return (
        <div className='factModal_wrapper'>
            ...
            <div className='factmodal_popup'>

                <RxCrossCircled onClick={handleCancel} />
                <div className='grid grid-cols-1 md:grid-cols-2 gap-10 font-light'>
