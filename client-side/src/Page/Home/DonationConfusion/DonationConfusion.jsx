    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 px-10 py-16 gap-8">
            <div className="card w-full bg-base-100 shadow-xl group ">
                <figure><img className='hover:scale-110 transition h-60 md:h-64 w-full' src={img1} alt="Donor" /></figure>
            ...
            <div className="card w-full bg-base-100 shadow-xl group">
                <figure><img className='hover:scale-110 transition h-60 md:h-64  w-full' src={img2} alt="Donor" /></figure>
                ...
                <div className="card-body p-0">
                    <div className='px-10 text-center space-y-4 py-12'>
                        ...
                        <p className='text-sm '>The act of giving blood is a selfless and impactful way to make a positive contribution to society. Every year, millions of lives are saved through blood transfusions, making blood donation an essential and life-saving practice. </p>
            ...
            <div className="card w-full  bg-base-100 shadow-xl group">
                <figure><img className='hover:scale-110 transition h-60 md:h-64  w-full' src={img3} alt="Donor" /></figure>
                ...
                <div className="card-body p-0">
                    ...
                    <div className="relative" >
                        <Link to={'/donationHelps'}> <button className="bottom-0 py-2 px-3 confusion-btn absolute text-gray-200 w-full font-semibold text-center">Read More</button></Link>
                    </div>
